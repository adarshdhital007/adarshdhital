...
const BookCard: React.FC<BookCardProps> = ({
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-neutral-800 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-neutral-200 dark:border-neutral-800">
